...
def game_start_juego_1(lista_preguntas_ya_hechas:list)->list|None:
    ...
    #PALCO DE VOTACION/JURADO + USUARIO + FONDO
    ...
    #ESPACIOS ENTREJURADOS Y SUS MESAS
    espacio_jurados = 120
    ...
    while bandera:
        ...
        if contador_jurados_votos == 5 :
            ...
            if decicion == 1 or decicion == 2 or decicion == 3: 
                texto = fuente.render(f"{ganador}",False,BLANCO,NEGRO)
                texto_usuario_decicion = fuente.render(f"{resultado_juego}",False,BLANCO,NEGRO)
        ...
        if contador_jurados_votos != 5:
            ...
            pygame.draw.rect(PANTALLA,ROJO,(420,535,170,30))
            pygame.draw.rect(PANTALLA,AZUL,(620,535,180,30))

            opcion_uno = respuesta[0] # OPCION ROJA
            opcion_dos = respuesta[1] #OPCION AZUL  
